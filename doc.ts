...
const LIST: SmartContractTemplate[] = [
    {
      ...
      blockchains: [Blockchain.POLYGON, Blockchain.AVALANCHE, Blockchain.BINANCE, Blockchain.ETHEREUM],
      compilationDetails: {
      ...
      isAudited: false,
      order: 1,
      tags: [SmartContractTemplateTags.NFT],
    },
    {
    ...
    <li><strong>initialOwnerOrMultisigContract: </strong> The address that will own the ERC20 contract</li>
      ...
      isAudited: false,
      order: 4,
      tags: [SmartContractTemplateTags.FUNGIBLE],
    },
    {
    ...
    <li><strong>definitiveFeeReceiver: </strong> The address that will receive all the price paid to mint the NFTs</li>
      ...
      isAudited: false,
      order: 6,
      tags: [SmartContractTemplateTags.SALE],
    },
    {
      id: "ERC1155_SALE",
    ...
    },
    {
      ...
      isAudited: false,
      order: 12,
      tags: [SmartContractTemplateTags.OTHER],
    },
    {
      ...
      isAudited: false,
      order: 92,
      tags: [SmartContractTemplateTags.DEPRECATED],
    },
    {
